...
class ToastUtils private constructor() {
    ...
    companion object {
        ...
        private var yOffset = (64 * MyApp.app.resources.displayMetrics.density + 0.5).toInt()
        ...
        fun setView(@LayoutRes layoutId: Int) {
            val inflate = MyApp.app.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        ...
        fun showShort(format: String?, vararg args: Any) {
            if (format.isNullOrEmpty() && args.isEmpty()) return
        ...
        private fun show(@StringRes resId: Int, duration: Int) {
            show(MyApp.app.resources.getText(resId).toString(), duration)
        }
        ...
        private fun show(@StringRes resId: Int, duration: Int, vararg args: Any) {
            show(String.format(MyApp.app.resources.getString(resId), *args), duration)
        }
        ...
        private fun showIt(text: CharSequence?, duration: Int) {
            ...
            if (customView != null) {
                ...
                if (sToast==null) {
                    sToast = Toast.makeText(MyApp.app, text, duration)
                    sToast!!.setGravity(gravity, xOffset, yOffset)
                } else {
                    sToast!!.duration = duration
                    sToast!!.setText(text)
        ...
        fun nonNull(s: String) {
            Companion.showShort("${s}不能为空")
        }
    }
}